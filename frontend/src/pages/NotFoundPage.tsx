...
export default function NotFoundPage() {
  ...
  return (
    <main className="min-h-[70vh] flex flex-col items-center justify-center px-4 py-16 text-center animate-in fade-in duration-500">
      ...
      <h1 className="text-3xl font-extrabold text-slate-800 dark:text-white mb-3">{t('notFound.title', 'Page not found')}</h1>
      <p className="text-slate-500 dark:text-gray-400 max-w-sm mb-8 leading-relaxed">
        {t('notFound.description', "The page you're looking for doesn't exist or may have been moved. Let's get you back on track.")}
      </p>
      ...
      <div className="flex flex-wrap items-center justify-center gap-3">
        ...
        >
          <Home size={16} /> {t('notFound.home', 'Back to Home')}
        </button>
      </div>
    </main>
  );
